...
<body>
<div id="box_logo">
<h1 style="font:50px Arial, Helvetica, sans-serif; color:#0C0;"><strong>CATÁLOGO ONLINE</strong></h1>
...
<div id="conterner_produto">
    ...
    <table style="border:1px solid #CCC; text-transform:uppercase; text-align:center; border-radius:10px; height:250px; padding:0; float:left; margin:5px 5px 5px 5px; font:12px Arial, Helvetica, sans-serif;" width="300" border="0">
      <tr>
        ...
        <h1 style="font:17px Arial, Helvetica, sans-serif; color:#00F; margin:5px 0 0 0;"><strong>R$ <? echo number_format($res_produto['valor_venda'],2,',','.'); ?></strong></h1>
        <h2 style="font:8px Arial, Helvetica, sans-serif; margin:0 0 0 0;">COD.<? echo $res_produto['code']; ?></h2>
      <? if($res_produto['estoque'] <=0){ ?>
        <h3 style="font:12px Arial, Helvetica, sans-serif; color:#F00; margin:0px 0 0 0;">Venda sob encomenda</h3>
      <? }else{ ?>
       <h3 style="font:12px Arial, Helvetica, sans-serif; color:#0C0; margin:0px 0 0 0;">Em estoque</h3></td>
      </tr>      
      <? } ?>
    </table>
    <?	}}} ?>
