...
<?
$valor_total = 0;
$sql_conjunto = mysqli_query($conexao_bd, "SELECT * FROM pagamento_boletos WHERE conjunto = '$code_conjunto' AND status != 'CANCELADO'");
...
<table width="300" border="0" style="page-break-before: always;">
  <tr>
    ...
    <strong><? if($verifica_pagador == 1){ echo "VESTE PRIME"; }else{ echo "VESTE PRIME"; } ?></strong><br />Identificador: <? echo $res_verifica['id']; ?></td>
  </tr>
  <tr>
  ...
  <tr>
    ...
    <? echo $data_completa; ?><br />
	 <? if($verifica_pagador == 0){ }else{ ?>
        &nbsp;&nbsp;&nbsp;&nbsp;
    <? } ?>    
     <? if($verifica_pagador == 1){ echo " VESTE PRIME "; }else{ echo " VESTE PRIME "; } ?>
    <br />
    </td>
  </tr>
  <tr>
    <td colspan="3">==========================================<br />
    <p>
    <? if($res_verifica['tipo'] == 'BOLETO'){ ?> RECIBO SIMPLES <? }else{ ?> RECIBO SIMPLES  <? } ?>
    </p>
    ==========================================<br />
    </td>
  </tr>
...
<table width="300" border="0">
  ...
  <tr>
	...
	?>
    <br />
    *Recibo simples, se precisar do comprovante de pagamento bancário ou 2° via, pode solicitar pelo (85) 99158.7323
    </td>
    </tr>
</table>
