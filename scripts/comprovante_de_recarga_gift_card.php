...
<table width="305" border="1">
  <tr>
    <td colspan="2" align="center" bgcolor="#0033CC"><h1><img src="../img/logo.png" width="229" height="95" /></h1>
      <h2>COMPROVANTE DE COMPRA DE GIFT CARD<br />
...
<strong>telefone: </strong>(85) 3315.6219</td>
  ...
  <tr>
    <td width="139" align="center" bgcolor="#FFFFFF"><strong>GIFT CARD</strong></td>
    <td width="149" align="center" bgcolor="#FFFFFF"><strong>VALOR</strong></td>
  </tr>
  <tr>
    <td height="20" align="center" bgcolor="#FFFFFF"><? echo $_GET['gift_card']; ?>&nbsp;</td>
    <td align="center" bgcolor="#FFFFFF">R$ <? echo number_format($_GET['valor_recarga'], 2, ',', '.'); ?>&nbsp;</td>
  </tr>
  <tr>
    <td colspan="2" align="center" bgcolor="#FFFFFF"><strong>NSU</strong></td>
  </tr>
  <tr>
    <td colspan="2" align="center" bgcolor="#FFFFFF"><? echo $_GET['nsu']; ?></td>
  </tr>
  <tr>
...
<? $codigo_produto = $_GET['autenticacao']; $tipo_servico = "GIFT CARD"; require "gerar_cupom_sorteio.php"; ?>
