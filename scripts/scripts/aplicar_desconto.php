...
if(mysqli_num_rows($verifica_senha) == ''){
	...
	mysqli_query($conexao_bd, "INSERT INTO pagamento_carrinho (status, ip, dia, mes, ano, data, data_completa, code_carrinho, form_pag, valor_total, cliente, operador, descontos, parcelas, cartao, valor_fornecido, valor_parcela, quant_parcelas, status_cheque, troco) VALUES ('Ativo', '$ip', '$dia', '$mes', '$ano', '$data', '$data_completa', '$carinho', 'DESCONTO LOJA', '$valor_desconto', '$cliente', '$operador', '$valor_desconto', '', '', '', '', '', '', '')");
