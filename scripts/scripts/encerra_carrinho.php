...
<table width="305" border="1">
  <tr>
    <td colspan="4" align="center" bgcolor="#0033CC"><h1><strong>VESTE PRIME</strong><hr /></h1> <h2><img src="../img/logo.png" width="229" height="95" /></h2>
      <h2>CUPOM DE VENDA DE PRODUTOS/SERVI&Ccedil;OS<br /><?  echo date("d/m/Y H:i:s");?><br />
      </h2>
    </td>
  </tr>
  <tr>
...
<strong>telefone: </strong>(85) 3315.6199</td>
  ...
  <? } ?>
  <tr>
    <td height="38" colspan="4" align="center" bgcolor="#FFFFFF"><h1 class="h5">
    <strong>*ESTE CUPOM É O ÚNICO COMPROVANTE DE COMPRA, SENDO OBRIGATÓRIO SUA APRESENTAÇÃO JUNTAMENTE COM O DOCUMENTO DE IDENTIFICAÇÃO EM CASO DE TROCA OU ACIONAMENTO DE GARANTIA DE PRODUTO.</strong>
    <br /> <br />
