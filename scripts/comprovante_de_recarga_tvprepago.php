...
<table width="305" border="1">
  <tr>
    <td colspan="2" align="center" bgcolor="#0033CC"><h1><img src="../img/logo.png" width="229" height="95" /></h1>
      <h2>COMPROVANTE DE RECARGA TV PRE PAGO<br />
...
<strong>telefone: </strong>(85) 3315.6219</td>
  ...
  <tr>
    <td colspan="2" align="center" bgcolor="#FFFFFF"><strong>OPERADORA de tv</strong></td>
  </tr>
  <tr>
    <td height="20" colspan="2" align="center" bgcolor="#FFFFFF"><? echo $_GET['tv']; ?></td>
  </tr>
  <tr>
    <td width="139" align="center" bgcolor="#FFFFFF"><strong>NSU</strong></td>
...
<? $codigo_produto = $_GET['autenticacao']; $tipo_servico = "RECARGA DE TV PRÉ-PAGO"; require "gerar_cupom_sorteio.php"; ?>
