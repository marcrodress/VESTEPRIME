...
mysqli_query($conexao_bd, "UPDATE pagamentoboletos SET status = 'CANCELADO', motivo_cancelamento = '$motivo', operador_cancelamento = '$operador', data_cancelamento = '$data_completa' WHERE id = '".$_GET['id']."'");
