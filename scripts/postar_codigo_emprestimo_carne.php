...
mysqli_query($conexao_bd, "UPDATE boletos_emprestimo_boleto SET codigo_barras = '$codigo_barras', localizador = '$localizador', vencimento = '$vencimento' WHERE id = '".$_GET['id']."'");
