...
<link href="css/cancela_saque.css" rel="stylesheet" type="text/css" />
</head>
...
mysqli_query($conexao_bd, "UPDATE saque_banco_brasil SET status = 'Cancelado', motivo_cancelamento = '$motivo', operador_cancelamento = '$operador' WHERE id = '$id'");
