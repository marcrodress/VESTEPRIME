...
<table width="1000" border="0">
    ...
    <td width="126" align="center" rowspan="3"><img src="
	  ...
	  if($banco == '077'){
		...
		echo "https://upload.wikimedia.org/wikipedia/commons/thumb/c/ca/Banco_BMG.svg/1200px-Banco_BMG.svg.png";
	  	...
	  	echo "https://static5.vvale.com.br/wp-content/uploads/2013/12/banco-do-brasil-logo.jpg";
	  }
  ...
  <tr>
    ...
    Correspondente autorizado: VESTE PRIME</td>
  ...
  <tr>
    ...
    <td colspan="4" bgcolor="#FF9900">
     <? if($banco == '077'){ ?>
     <strong style="font:20px Arial, Helvetica, sans-serif; margin:0; padding:0;">N&Atilde;O RECEBER AP&Oacute;S O VENCIMENTO</strong>
     <? }else{ ?>
