...
<link href="css/autorizacao_debito_em_conta.css" rel="stylesheet" type="text/css" />
</head>
...
<table width="279" border="1">
  <tr>
    <td colspan="2" align="center" bgcolor="#0033CC"><h1><img src="../img/logo.png" width="270" height="123" /></h1> 
      <h2>COMPROVANTE DE VENDA COM D&Eacute;BITO EM CONTA<br /><?  echo date("d/m/Y H:i:s");?><br />
    </h2>
  </td>
  </tr>
  <tr>
    <td width="133" bgcolor="#CCCCCC"><strong>cliente</strong></td>
    <td width="155" bgcolor="#CCCCCC"><strong>valor da transA&Ccedil;&Atilde;O</strong></td>
  </tr>
  <tr>
