...
<table width="900" border="0">
  ...
  <tr>
    ...
    <td align="center" bgcolor="#FFFFFF">
		...
		$juros = 0;
		if($res_boletos['status'] == 'AGUARDA' && $code_vencimento_hoje > $res_boletos['vencimento']){
			$juros = $res_boletos['valor']*0.01*($code_vencimento_hoje-$res_boletos['vencimento']);
			echo number_format($juros,2,',','.');
		}
		?>    
    </td>
    <td align="center" bgcolor="#FFFFFF"><? echo number_format($juros+$multa+$res_boletos['valor'],2,',','.'); ?></td>
  </tr>
</table>
<? }} ?>
...
<table width="900" border="0">
  ...
  <tr>
    ...
    </strong>Correspondente autorizado Banco do Brasil: Veste Prime</td>
    <td bgcolor="#FFFFFF"><strong>Ag&ecirc;ncia/ C&oacute;digo Benefici&aacute;rio <br />
    2622-2 / 30604-5</strong></td>
  </tr>
  <tr>
    <td colspan="2" bgcolor="#FFFFFF"><img src="../img/nao_aceitar.fw.png" width="722" height="30" /></td>
  ...
  <tr>
    <td colspan="2" rowspan="5" bgcolor="#FFFFFF"><strong>OBSERVA&Ccedil;&Otilde;ES AO CAIXA</strong><br />
      ...
      <ul>
        <li>AP&Oacute;S O VENCIMENTO, SOLICITE OUTRO BOLETO PELO TELEFONE/WHATSAPP +55 (11) 96665-9661</li>
