...
<link href="css/deposito_banco_do_brasil.css" rel="stylesheet" type="text/css" />
...
<div id="box_deposito">
<h1><strong>INFORMAÇÃO DE DEPÓSITO BANCO DO BRASIL</strong></h1>
<hr />
...
<table class="table table-striped table-bordered" width="1000" border="0">
  <tr>
    ...
    <td bgcolor="#999999"><strong>FAVORECIDO</strong></td>
    <td bgcolor="#999999"><strong>VALOR</strong></td>
    <td bgcolor="#999999"><strong>Nº DOCUMENTO</strong></td>
  ...
  <tr>
    ...
    <td>
      <select name="tipo_conta" size="1" id="select">
        ...
        <option value="OUTRAS POUPAN&Ccedil;AS">OUTRAS POUPAN&Ccedil;AS</option>
      </select></td>
...
mysqli_query($conexao_bd, "INSERT INTO deposito_banco_brasil (codeCaixa, turno, ip, dia, mes, ano, data, data_completa, status, operador, data_deposito, agencia, tipo_conta, conta, favorecido, valor, n_documento, cliente, motivo_cancelamento, operador_cancelamento) VALUES ('$codeCaixa', '$turno', '$ip', '$dia', '$mes', '$ano', '$data', '$data_completa', 'Ativo', '$operador', '$data_deposito', '$agencia', '$tipo_conta', '$conta', '$favorecido', '$valor', '$n_documento', '', '', '')");
...
<li>Ao informar o depósito para o sistema, por favor, certifique se o mesmo realmente foi realizado.</li>
<li>Cuidado para não digitar informações incorretas.</li>
</ul>
<hr />
<?

$sql_deposito = mysqli_query($conexao_bd, "SELECT * FROM deposito_banco_brasil WHERE data_deposito = '$data' AND status = 'Ativo'");
...
<table class="table table-striped table-bordered table-hover" width="1000" border="0">
  <tr>
    <td width="37" bgcolor="#999999"><strong>ID</strong></td>
    <td width="59" bgcolor="#999999"><strong>DATA</strong></td>
    <td width="106" bgcolor="#999999"><strong>AGÊNCIA</strong></td>
    <td width="136" bgcolor="#999999"><strong>TIPO DE CONTA</strong></td>
    <td width="113" bgcolor="#999999"><strong>CONTA</strong></td>
    <td width="234" bgcolor="#999999"><strong>FAVORECIDO</strong></td>
    <td width="96" bgcolor="#999999"><strong>VALOR</strong></td>
    <td width="128" bgcolor="#999999"><strong>Nº DOCUMENTO</strong></td>
  ...
  <tr <? if($i%2 == 0){ echo "bgcolor='#F0FFF8'"; }else{ echo "bgcolor='#FFFFDD'"; } ?>>
    ...
    <td>
    <? if($tipo == 'ADM'){ ?>
    <a rel="superbox[iframe][550x250]" href="scripts/cancela_deposito.php?id=<? echo $res_deposito['id']; ?>"><img src="img/deleta.jpg" width="18" height="18" border="0" /></a>
    <? } ?>    
    </td>
  </tr>
  <? } ?>
