...
$sql_vencimento = mysqli_query($conexao_bd, "SELECT * FROM faturas_fechadas WHERE code_vencimento = '$code_vencimento_hoje' AND sit_pag = 'AGUARDA PAGAMENTO' AND id = '$id_fatura'");
...
curl_setopt_array($curl, array(
  CURLOPT_URL => "https://api.smsdev.com.br/v1/send?key=TZXZSWGNSZY51PZTLQ1SI772BRGA1FGQAKH16GEYTWKMUBSHF2K5D4O4REAUCWD2KG686DRENLFCJZKQT0FEJ4V1YSVICR1DCRU1PJW2OZIW48VKFQ8V084I82QJ5SSZ&type=9&number=$telefone_cliente&msg=".urlencode("VESTE PRIME: Hoje é vencimento da sua fatura no valor de R$ $saldo. Vencimento: $vencimento. Mais informações acesse seu e-mail.
