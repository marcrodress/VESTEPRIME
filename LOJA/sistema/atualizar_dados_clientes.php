...
<link href="css/atualizar_dados_clientes.css" rel="stylesheet" type="text/css" />
<link href="img/logo.png" rel="shortcut icon" />
</head>

<body>
<div id="box_cadastro_de_cliente">
 <h1>Atualizar dados de clientes<hr /></h1>
...
if(mysql_num_rows($sql) == ''){
	echo "<script language='javascript'>window.alert('Cliente não encontrado, talvez o CPF esteja incorreto!');</script>";
}else{
	while($res_1 = mysql_fetch_array($sql)){
		$cpf = $res_1['cpf'];
?>	
<a class="a" href="scripts/atualizar_dados_pessoais.php?id=<? echo $res_1['id']; ?>&cpf_cliente=<? echo $res_1['cpf']; ?>&pg=digitar_senha&operador=<? echo $nome_operador; ?>&cpf_operador=<? echo $cpf_operador; ?>" rel="superbox[iframe][1200x600]"><strong>Atualizar dados pessoais</strong></a>
<a class="a" rel="superbox[iframe][1280x630]" href="scripts/atualizar_dados_profissionais.php?id=<? echo $res_1['id']; ?>&cpf_cliente=<? echo $res_1['cpf']; ?>&pg=digitar_senha&operador=<? echo $nome_operador; ?>&cpf_operador=<? echo $cpf_operador; ?>"><strong>Atulizar dados profissionais</strong></a>
<a class="a" rel="superbox[iframe][630x300]" href="scripts/atualizar_cpf.php?id=<? echo $res_1['id']; ?>&cpf_cliente=<? echo $res_1['cpf']; ?>&operador=<? echo $nome_operador; ?>&cpf_operador=<? echo $cpf_operador; ?>"><strong>Atulizar CPF</strong></a>
<a class="a" rel="superbox[iframe][630x300]" href="scripts/atualizar_acesso.php?id=<? echo $res_1['id']; ?>&cpf_cliente=<? echo $res_1['cpf']; ?>&senha=<? echo $res_1['senha']; ?>&email=<? echo $res_1['email']; ?>&operador=<? echo $nome_operador; ?>&cpf_operador=<? echo $cpf_operador; ?>"><strong>Atulizar acesso</strong></a>
<a class="a" rel="superbox[iframe][630x180]" href="scripts/enviar_documentacao.php?id=<? echo $res_1['id']; ?>&cpf_cliente=<? echo $res_1['cpf']; ?>&senha=<? echo $res_1['senha']; ?>&email=<? echo $res_1['email']; ?>&operador=<? echo $nome_operador; ?>&cpf_operador=<? echo $cpf_operador; ?>"><strong>Enviar documentos</strong></a>
<a class="a" rel="superbox[iframe][1200x650]" href="scripts/mostrar_documentos.php?id=<? echo $res_1['id']; ?>&cpf_cliente=<? echo $res_1['cpf']; ?>&senha=<? echo $res_1['senha']; ?>&email=<? echo $res_1['email']; ?>&operador=<? echo $nome_operador; ?>&cpf_operador=<? echo $cpf_operador; ?>"><strong>Mostrar todos documentos</strong></a>
<a class="a" rel="superbox[iframe][1200x650]" href="scripts/mostrar_comprovantes_de_renda.php?id=<? echo $res_1['id']; ?>&cpf_cliente=<? echo $res_1['cpf']; ?>&senha=<? echo $res_1['senha']; ?>&email=<? echo $res_1['email']; ?>&operador=<? echo $nome_operador; ?>&cpf_operador=<? echo $cpf_operador; ?>"><strong>Mostrar todos comprovantes de renda</strong></a>
<br />
<hr />
...
var sprytextfield1 = new Spry.Widget.ValidationTextField("sprytextfield1", "phone_number", {format:"phone_custom", pattern:"000.000.000-00", useCharacterMasking:true});
</script>
</body>
</html>