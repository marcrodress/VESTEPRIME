...
<form action="scripts/conversao_emprestimo_carteira_assinada.php" method="post" enctype="multipart/form-data" name="confirma_send" target="_blank">
<table width="1129" border="0">
  <tr>
    ...
    <td width="265" colspan="2"><strong>Telefone:</strong> (85) 3315.6219/9233.0928</td>
  </tr>
  <tr>
    <td colspan="4"><hr></td>
  </tr>
  ...
  <tr>
    ...
    <td><strong>Profiss&atilde;o: Tempo de servi&ccedil;o:</strong></td>
    <td><strong>Empresa:</strong></td>
  </tr>
  <tr>
    <td><h3><? echo $res_1['sit_profissional']; ?></h3></td>
    <td><? echo $res_1['profissao'];
 ?> / <? echo $res_1['tempo_de_servico'];
 ?></td>
    <td><h3><? echo $res_1['nome_empresa']; ?></h3></td>
</tr>
  <tr>
    <td><strong>Endere&ccedil;o da empresa:</strong></td>
    <td><strong>Bairro:</strong></td>
    <td><strong> Cidade:</strong></td>
  </tr>
  <tr>
    <td><h3><? echo $res_1['endereco_empresa']; ?> - <? echo $res_1['numero_da_empresa']; ?></h3></td>
    <td><h3><? echo $res_1['bairro_empresa']; ?></h3></td>
    <td><? echo $res_1['cidade_empresa']; ?></td>
</tr>
  <tr>
    <td><strong>Estado:</strong></td>
  ...
  <tr>
    <td><? echo $res_1['estado_sede']; ?></td>
    <td><? echo $res_1['dia_pagamento']; ?></td>
    <td><? echo $res_1['tele_empresa']; ?></td>
  </tr>
  <tr>
  ...
  <tr>
    <td><? echo $res_1['cnpj']; ?></td>
    <td><? echo $res_1['renda_mensal']; ?></td>
      ...
      <table width="1130" border="0">
        ...
        <tr>
          <td><h3>
            ...
            <input name="valor" type="text" class="input3" id="valor" value="<? echo number_format($_POST['valor'],2,",","."); ?>" />
            <input name="valor2" type="hidden" value="<? echo $_POST['valor']; ?>" />
          </h3></td>
          <td><h3>
            <label for="meses"></label>
            <input class="input3" type="text" name="meses" id="meses" />
          </h3></td>
          <td><h3>
            <input class="input3" type="text" name="parcela" />
          </h3></td>
          </tr>
        <tr>
          <td height="23">&nbsp;</td>
