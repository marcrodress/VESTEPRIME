...
echo "<script language='javascript'>window.alert('Resultado proposta cadastrada com sucesso!');window.location='../?pack=Eb5S&tipo=analise_de_proposta_cartao';</script>";
