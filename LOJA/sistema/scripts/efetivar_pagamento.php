...
mysql_query("UPDATE pagamento_boletos SET operador_efetivado = '$operador', data_efetivado = '$data', forma_processamento = '$forma_processamento', banco_processamento = '$banco', tarifa_processamento = '$tarifa', comissao = '$comissao', data_pagamento = '$data_pagamento', observacao = '$observacao', status = 'Efetivado' WHERE id = '".$_GET['id']."'");
