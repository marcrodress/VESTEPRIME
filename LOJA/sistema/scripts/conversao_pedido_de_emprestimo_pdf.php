  ...
  <tr>
    <td colspan="4"><table width="961" border="0">
      ...
      <tr>
        ...
        <td colspan="2">
        <? if($res_1['n_inss'] == ''){}else{ ?>
        <strong>N&uacute;mero do ben&eacute;ficio do  INSS:<h3> <? echo $res_1['n_inss']; ?></h3></strong>
        <? } ?>
        </td>
        </tr>
      <tr>
        <td><? echo $res_1['sit_profissional']; ?></td>
    ...
    <table width="961" border="0">
      ...
      <tr>
        <td><h3><? echo $res_2['valor_solicitado']; ?></h3></td>
        <td><h3><? echo $res_2['quantidade_parcelas']; ?></h3></td>
        <td><h3><? echo $res_2['valor_parcelas']; ?></h3></td>
      </tr>
    </table>    <? } ?>
      </td>
  </tr>
