...
mysql_query("INSERT INTO acoes_cadastro (ip, date, id_cliente, cpf, nome_acao, executor) VALUES ('$ip', '$date', '$id', '$cpf_cliente', 'Atualização de dados de acesso', 'Atendente - $operador CPF: $cpf_operador')");
...
<div id="box_atualiza_cpf">
 <table width="450" border="0" align="center">
  ...
  <tr>
    ...
    <td width="225">Repita a nova senha:</td>
  </tr>
  <tr>
