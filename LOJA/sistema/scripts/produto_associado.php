...
$sql_1 = mysql_query("SELECT * FROM codigos_associados WHERE codigo_barras = '$code_barras'");

 if(mysql_num_rows($sql_1) == ''){
	 mysql_query("INSERT INTO codigos_associados (produto_original, codigo_barras) VALUES ('$produto_original', '$code_barras')");
