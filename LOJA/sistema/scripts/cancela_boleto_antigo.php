...
mysql_query("UPDATE pagamento_contas SET status = 'CANCELADO', motivo_cancelamento = '$motivo', operador_cancelamento = '$operador', data_cancelamento = '$data_completa' WHERE id = '".$_GET['id']."'");
