...
<table width="1180" border="0">
  <tr>
    <td colspan="5"><strong>Relação das atividades que falta ser executadas</strong></td>
  </tr>
  <tr>
    <td colspan="5"><hr /></td>
  </tr>
...
<? while($res_1 = mysql_fetch_array($sql_1)){ ?>
  ...
  <tr>
    <td><strong>Descrição da atividade:</strong></td>
    <td>&nbsp;</td>
    <td>&nbsp;</td>
...
mysql_query("UPDATE atividades SET status = 'Excluído' WHERE id = '$id'");
