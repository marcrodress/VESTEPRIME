...
<table width="990" border="0">
  <tr>
    <td colspan="5" align="center" bgcolor="#333333"><h1 style="font:20px Arial, Helvetica, sans-serif;"><strong>DADOS DE CR&Eacute;DITO SOLICITADO</strong></h1></td>
  </tr>
  <tr>
  ...
  <tr>
    <td colspan="2" bgcolor="#666666"><strong>RESULTADO DA ANALISE DE CR&Eacute;DITO:</strong><br /> <? echo $res_emprestimo['status']; ?></td>
    <td bgcolor="#666666"><strong>OPERADOR:</strong> <br />
      <? echo $res_emprestimo['operador']; ?></td>
    <td bgcolor="#666666"><strong>FIADOR:</strong> <br />
      <? echo $res_emprestimo['cpf_fi']; ?><br />

      </td>
    <td bgcolor="#666666"><strong>ADMINISTRA&Ccedil;&Atilde;O DE CONTRATO</strong><br />
      
	  <? if($res_emprestimo['status'] == 'APROVADO'){ ?>
      <a target="_blank" href="scripts/imprimir_contrato_carne.php?cpf=<? echo $res_emprestimo['cpf']; ?>&n_proposta=<? echo $res_emprestimo['n_proposta']; ?>"><img src="img/cadastro.fw.png" alt="" width="20" height="20" border="0" title="IMPRIMIR CONTRATO" /></a>
      <a target="_blank" href="scripts/boletos_carne_emprestimo.php?proposta=<? echo $n_proposta; ?>" title="Emitir carn&ecirc; completo"><img src="img/carne_pagamento.png" width="18" height="20" border="0" /></a> 
      <a  target="_blank" href="scripts/capa_boletos_carne_emprestimo.php?proposta=<? echo $n_proposta; ?>" title="Emitir carn&ecirc; completo"><img src="img/capa_carne.png" width="18" height="20" border="0" /></a>
      <? } ?>
	   ...
	   <? if($_GET['pgc'] == 'confirmar_credito'){
			...
			echo "<script language='javascript'>window.alert('Confirmação enviada com sucesso! O Credito na conta do cliente ocorrerá em no máximo 72 horas úteis');window.location='?pg=detalhe&code=$code';</script>";
...
<script language="Javascript">
        function confirmacao(id) {
             var resposta = confirm("Tem certeza que todos os dados estão corretos e o contrato devidamente assinado?");
             ...
             if (resposta == true) {
              ...
              <a href="javascript:func()" onclick="confirmacao('<? echo $res_emprestimo['id']; ?>')"><img src="img/correto.fw.png" width="18" height="18" border="0" title="AUTORIZAR LIBERAÇÃO DO CRÉDITO"></a>
      <? } ?>
  ...
  <? if(isset($_POST['button'])){
   ...
   if($status == 'NEGADO'){
    mysqli_query($conexao_bd, "UPDATE boletos_emprestimo_boleto SET status = 'NEGADO' WHERE proposta = '$n_proposta'");
   }
 ...
 <? if($res_emprestimo['status'] == 'APROVADO' || $tipo == 'ADM'){ ?>
  ...
  <tr>
    <td colspan="5" bgcolor="#000000"><table class="td" width="960" align="center" border="0">
      <tr>
      ...
      <tr>
        <td width="63" bgcolor="#666666"><strong>PARCELA</strong></td>
        <td width="55" bgcolor="#666666"><strong>STATUS</strong></td>
        <td width="60" bgcolor="#666666"><strong>VALOR</strong></td>
        <td width="51" bgcolor="#666666"><strong>MULTA</strong></td>
        <td width="47" bgcolor="#666666"><strong>JUROS</strong></td>
        <td width="49" bgcolor="#666666"><strong>SALDO</strong></td>
        <td width="259" bgcolor="#666666"><strong>COD. BARRAS</strong></td>
        <td width="90" bgcolor="#666666"><strong>LOCALIZADOR</strong></td>
        <td width="82" bgcolor="#666666"><strong>VENCIMENTO</strong></td>
        <td width="69" bgcolor="#666666"><strong>PAGT.</strong></td>
        <td width="85" bgcolor="#666666">
 ...
 ?>
	  <tr <? if($i%2 == 0){ echo "bgcolor='#666'"; }else{ echo "bgcolor='#999'"; } ?>>
		...
		$juros = 0;
		if($res_parcela['status'] == 'AGUARDA' && ($code_vencimento_hoje > $res_parcela['vencimento'])){
			$juros = $res_parcela['valor']*0.001*($code_vencimento_hoje-$res_parcela['vencimento']);
			echo number_format($juros,2,',','.');
		}
		?></h4>
                </td>
        <td <? if($res_parcela['status'] == 'AGUARDA' && ($code_vencimento_hoje > $res_parcela['vencimento'])){ ?>bgcolor="#000"<? } ?>><h6><? echo number_format($juros+$multa+$res_parcela['valor'],2,',','.'); ?></h6></td>
        <td>
            <? if($tipo == 'ADM'){ ?>
        ...
        <? if($tipo == 'ADM'){ ?>
         <a rel="superbox[iframe][270x250]" href="scripts/confirmar_pagamento_emprestimo_carne.php?id=<? echo $res_parcela['id']; ?>&valor=<? echo number_format($juros+$multa+$res_parcela['valor'],2); ?>&proposta=<? echo $res_parcela['proposta']; ?>&tipo=carne_individual&ultimo=<? 
		 	
			if($res_parcela['parcela'] == $res_emprestimo['quant_parcela']){
				echo "SIM";
			}else{
				echo "NAO";
			}
		 
		  ?>&cpf=<? echo $res_parcela['cliente']; ?>&parcela=<? echo $res_parcela['parcela']; ?>"><img src="img/dinheiro.png" width="20" height="20" border="0" title="Confirmar pagamento" /></a>
        <? } ?>
...
$sql_emprestimo = mysqli_query($conexao_bd, "SELECT * FROM emprestimo_boleto WHERE cpf = '$cpf_cliente'");
...
<table class="table" width="1000" border="0">
  <tr>
    <td width="73" bgcolor="#666666"><h3><strong>PROPÓSTA</strong></h3></td>
    <td width="63" bgcolor="#666666"><h3><strong>DATA</strong></h3></td>
    <td width="67" bgcolor="#666666"><h3><strong>STATUS</strong></h3></td>
    <td width="220" bgcolor="#666666"><h3><strong>CLIENTE</strong></h3></td>
    <td width="65" bgcolor="#666666"><h3><strong>VALOR</strong></h3></td>
    <td width="62" bgcolor="#666666"><h3><strong>N&ordm;. PARCE.</strong></h3></td>
    <td width="44" bgcolor="#666666"><h3><strong>TAXA</strong></h3></td>
    <td width="94" bgcolor="#666666"><h3><strong>VL. PARCELA</strong></h3></td>
    <td width="59" bgcolor="#666666"><h3><strong>SITUA&Ccedil;&Atilde;O</strong></h3></td>
    <td width="78" bgcolor="#666666"><h3><strong>OP&Ccedil;&Otilde;ES</strong></h3></td>
  </tr>
  <? 
  $valor = 0;
...
$mail->FromName = "O BOLETO DE SEU CRÉDITO PESSOAL CHEGOU!";
...
$mail->Subject = "O BOLETO DE SEU CRÉDITO PESSOAL CHEGOU!";
