...
<h2 style="width:auto; text-align:center;"><strong>Foram encontrados <? echo mysqli_num_rows(mysqli_query($conexao_bd, "SELECT * FROM produtos WHERE codeProdutoPassivo = ''")); ?> produto(s)</strong>
  <br />
  <br />
  <a target="_blank" style="font:10px Arial, Helvetica, sans-serif; margin:0 0 -20px 0;" href="abrirListaDeCodigos.php">Lista de códigos</a>
    ...
    <h3>
      <a href="#" onclick="abrirQuantidadeCodigos(<? echo $res_verifica['code']; ?>);">
    	...
    	<strong><? echo $res_verifica['titulo']; ?></strong> 
    		<a onclick="abrirCodigoBarras(<? echo $res_verifica['code']; ?> );" style="float:right; margin:0;" href="#"><img width="40" title="Gerar código de barras desse produto" height="20" src="https://cdn.icon-icons.com/icons2/179/PNG/128/barcode_reader_128x128-32_22291.png" /></a>
    </h3>
    </td>
    </tr>
    ...
    <div class="col" style="margin:0 0 0 10px; text-align:center;">
        <nav aria-label="Navegação de página exemplo">
            <ul class="pagination">
                ...
                $paginas_exibidas = 18; // Número de páginas intermediárias a serem exibidas

                // Lógica para exibir as páginas intermediárias
                ...
                echo "<li class='page-item'><a class='page-link' href='?pagina=$proxima'>Próximo</a></li>";
                ?>
            </ul>
        </nav>
    </div>
