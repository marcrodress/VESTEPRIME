...
if($parcela >1){
  ...
  mysqli_query($conexao_bd, "INSERT INTO pagamento_boletos_opcoes (code_boleto, data, data_completa, dia, mes, ano, operador, status, forma_pagamento, n_parcelas, bandeira, valor, valor_parcela, valor_transacao, cliente, limite_antes, limite_consumido, troco, cheque_especial, conjunto) VALUES ('$code_boleto', '$data', '$data_completa', '$dia', '$mes', '$ano', '$operador', 'Ativo', '$pag_form', '1', '$bandeira', '$valorusar', '$valorusar', '$valorusar', '$cliente', '', '', '', '', '$code_conjunto')");
