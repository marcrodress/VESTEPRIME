...
<table width='800' align='center' style='border:20px solid #090; border-radius:50px; padding:10px;' border='0'>
  ...
  <tr>
    ...
    <br><br>
    Este e-mail é para avisar que a parcela: $parcela de seu crédito pessoal vence em 3 dias. Para sua comodidade estamos enviando em anexo o boleto de pagamento.</strong></h1>
  ...
  <tr>
    <td colspan='2' align='center'><p><a href='http://www.ikuly.com/caixa/scripts/boleto_emprestimo.php?id=$id&proposta=$proposta'><img src='http://ikuly.com/caixa/img/baixar_boleto.fw.png' alt='' width='272' height='78' border='0' /></a>
      ...
      <p><span style='font:20px Arial, Helvetica, sans-serif; color:#CC0; padding:2px;; font-family: Arial, Helvetica, sans-serif; font-size: 20px'><strong>Caso já tenha pago, por favor, desconsiderar esse e-mail.</strong></span>
      </p>
    <hr /></td>
  </tr>
  <tr>
