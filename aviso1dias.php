...
if($id_fatura > $total_fatura){
	echo "<script language='javascript'>window.location='aviso0dias.php?id_fatura=3000';</script>";
}else{


$sql_vencimento = mysqli_query($conexao_bd, "SELECT * FROM faturas_fechadas WHERE vencimento_um_dia = '$code_vencimento_hoje' AND sit_pag = 'AGUARDA PAGAMENTO' AND id = '$id_fatura'");
...
curl_setopt_array($curl, array(
  CURLOPT_URL => "https://api.smsdev.com.br/v1/send?key=TZXZSWGNSZY51PZTLQ1SI772BRGA1FGQAKH16GEYTWKMUBSHF2K5D4O4REAUCWD2KG686DRENLFCJZKQT0FEJ4V1YSVICR1DCRU1PJW2OZIW48VKFQ8V084I82QJ5SSZ&type=9&number=$telefone_cliente&msg=".urlencode("VESTE PRIME: Falta 1 dia para o vencimento da sua fatura no valor de R$ $saldo. Vencimento: $vencimento. Mais informações acesse seu e-mail.
...
$mail->FromName = "SUA FATURA VENCE EM 1 DIA!";
...
<table width='800' align='center' style='border:20px solid #FC0; border-radius:0; padding:10px;' border='0'>
  ...
  <tr>
    ...
    <br><br>
    A fatura do seu cartão vence em 1 dia, o valor para pagamento é de R$ $saldo com vencimento em $vencimento.</strong></h1></td>
...
$mail->Subject = "SUA FATURA VENCE EM 1 DIA!";
